<template>
  <el-card class="box-card" ref="boxCard">
    <div class="h_box">
    <span>班级查询：</span><el-input v-model="keyword" class="query_input" placeholder="班级 / 班主任"></el-input>
    <el-button
        class="query_bt"
        type="primary"
        @click="getClassList"
        >查询</el-button
      >
      <el-button class="add_bt" type="primary" @click="centerDialogVisible = true"
        >添加班级</el-button
      >
    </div>
    <el-table
    ...
    >
      ...
      <el-table-column prop="user.username" label="班主任"> </el-table-column>
    ...
    <el-dialog
      ...
      center
    >
      <el-form ref="updateForm" :model="addForm" label-width="100px">
        <el-form-item label="班级名称：">
          <el-input v-model="addForm.classname"></el-input>
        </el-form-item>
        <el-form-item label="班主任：">
          <el-select v-model="addForm.userId" placeholder="请选择班主任">
    ...
    >
      <el-form ref="updateForm" :model="updateForm" label-width="80px">
        ...
        <el-form-item label="班主任：">
          <el-select v-model="updateForm.userId" placeholder="请选择班主任">
            <el-option v-for="item in teaList" :key="item.id" :label="item.username" :value="item.id"></el-option>
          </el-select>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    // 获取所有班级
    async getClassList() {
      this.$axios.get("all_lass//admin/get_all_class",{params:{keyword:this.keyword}}).then((res) => {
